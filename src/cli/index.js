...
import log, { info, warn, error, LEVELS, setLevel } from '../util/log'
import deleteAction from '../action/deleteAction'
import listAction from '../action/listAction'
import { promiseWrap } from '../util/promiseUtils'

process.exitCode = 1 // assume no errors for now

log(` ABC version: ${packageVersion}`) // blank line to start with
